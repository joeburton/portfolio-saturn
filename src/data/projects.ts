export const projects = [
  ...
  },
  {
    ...
    company: "WorldFirst",
    description:
      "<p>I worked for World First as a contract Front-end Engineer for the first 6 months, before becoming permanent as a Senior Software Engineer, I was finally promoted to Front-end Team Lead. I initially worked on the trading platform integrating Xero accountancy software. After this I joined the statements team, where I implemented new UI features and components, improved the main platforms micro front-end codebases, moving from React Classes to React Hooks, increased test coverage and improved general code quality.</p><p>After being promoted to Front-end Team Lead, I was responsible for managing the team's goals, deliverables and managing individuals’ performance reviews.</p><p>During my time as Front-end Lead my team and I were heavily involved in helping deliver a new multi-regional front-end for the trading platform. On a day-to-day basis this involved working closely with back-end teams, Product, UX and Design across the UK and APAC to ensure everything ran as smoothly as possible.</p>",
    skills:
      "React, TypeScript, HTML, CSS, JavaScript, Jest, React Testing Library, Ant Design, LESS, Webpack, Storybook, Rollup, Node.js & Express.",
